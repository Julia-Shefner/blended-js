...
// Дано масив чисел [1, 2, 3, 4, 5]. Створіть новий масив,
...
// Дано масив об'єктів. Створіть новий масив, що містить
// всі значення з масивів values кожного об'єкту, збережених
// в одному масиві.
...
// - метод substruct - Віднімає value від поточного значення.
// Повертає this.

// - метод divide - Ділить поточне значення на value, якщо value
// не дорівнює 0. Якщо value === 0, викидає помилку з повідомленням
// про неможливість ділення. Повертає сам об'єкт (this) для підтримки
// ланцюжкових викликів.
...
//
// Потім Створіть клас `Employee`, який розширює клас `Person` і містить
